...
*** Test Cases ***
Test Parcours Utilisateur : Inscription, Connexion, Création Premier Compte Bancaire
    # Étape 1 : Inscription
    ...
    # Étape 4 : Vérification du solde du compte bancaire avant création d'un revenu
    ...
    # Étape 6 : Vérification du solde du compte bancaire après création d'un revenu
    ...
    # Étape 8 : Vérification du solde du compte bancaire après création d'une dépense
